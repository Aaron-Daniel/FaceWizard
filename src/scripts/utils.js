...
function getOAuthLink() {
    ...
    let clientID  = CLIENT_ID; //"caf06532-6787-45f3-a2e4-8ff02a55012f"
    let auth_base = AUTH_BASE; //"https://api.veritone.com/v1/admin/oauth/authorize?scope=all&response_type=token&client_id="
    let redirect = "&redirect_uri=" + HOME_URL; //https://musing-boyd-05e7b5.netlify.com/
